...
public class GameServiceTests {
    ...
    @Test
    void insertGameSuccessTest() throws DataAccessException, DataNotFoundException, DataAccessUnauthorizedException {
    ...
    @Test
    void insertGameFailureTest() throws DataAccessException, DataNotFoundException, DataAccessUnauthorizedException {
        authDAO.insertAuth(new AuthData("AuthToken", "MyUsername"));
        InsertGameRequest request = new InsertGameRequest("InvalidAuthToken", "myGame");
        Assertions.assertThrows(DataAccessUnauthorizedException.class, () -> gameService.insertGame(request));
    }

    @Test
    void joinGameSuccessTest() throws DataAccessException, DataNotFoundException, DataAccessUnauthorizedException {
    ...
    @Test
    void joinGameFailureTest() throws DataAccessException, DataNotFoundException{
        ChessGame chessGame = new ChessGame();
        authDAO.insertAuth(new AuthData("AuthToken", "MyUsername"));
        ...
        //invalid game id
        Assertions.assertThrows(DataNotFoundException.class, () -> gameService.joinGame(new JoinGameRequest("AuthToken", ChessGame.TeamColor.WHITE, 2)));
        //authTokenInvalid
        Assertions.assertThrows(DataAccessUnauthorizedException.class, () -> gameService.joinGame(new JoinGameRequest("InvalidAuthToken", ChessGame.TeamColor.WHITE, 1)));
    }
    @Test
    void listGameSuccessTest() throws DataAccessException, DataNotFoundException, DataAccessUnauthorizedException {
        authDAO.insertAuth(new AuthData("AuthToken", "MyUsername"));
    ...
    @Test
    void listGameFailureTest() throws DataAccessException, DataNotFoundException, DataAccessUnauthorizedException {
        authDAO.insertAuth(new AuthData("AuthToken", "MyUsername"));
        ListGamesRequest request = new ListGamesRequest("InvalidAuthToken");
        //invalid auth token
        Assertions.assertThrows(DataAccessUnauthorizedException.class, () -> gameService.listGames(request));
    }
}
